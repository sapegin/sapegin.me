...
description: 'A chapter from “Washing your code. A book on clean code for frontend developers” by Artem Sapegin. Splitting code into functions and modules, when the right time is to introduce an abstraction, and when it’s better to sleep on it'
...
![Autocompletion with calculated values](https://sapegin.me/images/blog/book/autocompletion-formula.png)
...
![Autocompletion with literal values](https://sapegin.me/images/blog/book/autocompletion-literals.png)
