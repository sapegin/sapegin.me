...
description: 'A chapter from “Washing your code. A book on clean code for frontend developers” by Artem Sapegin. Different techniques for editing code and customizing our environment to make our work more efficient and less tiring'
source: washing-code/150_Editing
---
...
![Fuzzy file opener in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-fuzzy-file-opener.png)
...
![Symbols in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-symbols.png)
...
- duplicate current line or selection (Cmd+D, **d**elete);
...
![Using multiple cursors](https://sapegin.me/images/blog/book/multiple-cursors.png)
...
![Tasks in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-tasks.png)
...
![Integrated terminal in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-terminal.png)
...
![Committing to Git in GitHub Desktop](https://sapegin.me/images/blog/book/github-desktop.png)
...
![Committing to Git in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-commit.png)
...
![Searching JavaScript documentation in Dash using Alfred integration](https://sapegin.me/images/blog/book/alfred-dash.png)
...
![Code Spell Checker for Visual Studio Code](https://sapegin.me/images/blog/book/vscode-spell-checker.png)

Typos in comments and names not only make the code slightly harder to read but also make it harder to search for. If we’re searching for `departureDate`, but in some places it’s misspelled as `depratureDate`, we won’t find those places.
...
- [Typos spell checker](https://marketplace.visualstudio.com/items?itemName=tekumara.typos-vscode): fixes common misspellings (for example, `ot` instead of `to`).
...
![GitHub Copilot inline chat](https://sapegin.me/images/blog/book/github-copilot-inline-chat.png)
...
![Command palette in Visual Studio Code](https://sapegin.me/images/blog/book/vscode-command-palette.png)
