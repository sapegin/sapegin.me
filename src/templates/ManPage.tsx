				...
				<Stack gap="l">
					...
					<Stack gap="m" as="section">
						...
						<Stack direction={{ mobile: 'column', tablet: 'row' }} gap="l">
							<Stack gap="s" as="ul">
								...
								<TextTypo as="li">
									<span aria-hidden="true">🥨</span> Live in Berlin, Germany,
									but originally from Soviet Russia
								</TextTypo>
								<TextTypo as="li">
					...
					<Stack gap="m" as="section">
						...
						<TextTypo>
							...
							office environment is too distracting, and I get overwhelmed by
							too many things going on around me. Also, being around people all
							day is draining, and the commute on public transport is too
							stressful for me.
						</TextTypo>
						<TextTypo>
							...
							answer, edit the text to make it clear, and have your response to
							reference later. I have trouble staying focused during calls and
							quickly forget important details (unless I make notes, which makes
					...
					<Stack gap="m" as="section">
						...
						<TextTypo>
							...
							overwhelmed. Feel free to tell me about it.
						</TextTypo>
						<TextTypo>
