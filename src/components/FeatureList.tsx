...
export function FeatureList(props: ComponentPropsWithoutRef<'ol'>) {
	return <ul className="ml-4 flex flex-col gap-4" {...props} />;
}

export function FeatureListItem({ children }: ComponentPropsWithoutRef<'li'>) {
	return (
		<li
			className="pl-1"
			style={{
